...
-- Requirements:
	...
	-- to an existing users) project_name, a new or already exists
	-- projects - if no projects.name found in the table, you should
	-- create it score, the score value for the correction
